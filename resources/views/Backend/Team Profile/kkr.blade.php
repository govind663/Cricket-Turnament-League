                        ...
                        <div class="app-card-body p-3 p-lg-4">
                            ...
                            <div class="row gx-5 gy-3">
                                <div class="col-12 col-lg-9">
                                    <div>
                                        The Kolkata Knight Riders (KKR) are a franchise cricket team representing the
                                        city of Kolkata in the Indian Premier League. The franchise is owned by
                                        Bollywood actor Shah Rukh Khan, actress Juhi Chawla and her spouse Jay Mehta.
                                        The Knight Riders play at the iconic Eden Gardens stadium.[5]

                                        The franchise, which has gained immense popularity due to its association with
                                        celebrity owners, qualified for the IPL playoffs for the first time in 2011.
                                        They became the IPL champions in 2012, by defeating Chennai Super Kings in the
                                        final. They repeated the feat in 2014, defeating Kings XI Punjab.[6] The Knight
                                        Riders hold the record for the longest winning streak by any Indian team in T20s
                                        (14).[7]
                                    </div>

                                    <p class="pt-3">
                                        <strong>Arena/Stadium</strong> : <span class="text-info">Eden Gardens, Kolkata</span><br>
                                        <strong>Owner</strong> : <span class="text-info">Knight Riders Group: (Red Chillies Entertainment (55%); Mehta Group (45%))</span><br>
                                        <strong>Coach</strong> : <span class="text-info">Brendon McCullum (Head coach)</span><br>
                                        <strong>Captain</strong> : <span class="text-info"> Eoin Morgan </span><br>
                                ...
                                <div class="col-12 col-lg-3">
                                    <img src="assets/images/teame/KKR.png" alt="" height="200px" width="200px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Chris.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                            <div class="___class_+?50___ pt-2">
                                                <h4>Chris Green</h4>
                                                <p class="text-muted"><span>Bowling Allrounder • Australia</span></p>
                                            </div>
                                            <ul class="social-links list-inline">
                                                <li class="list-inline-item"><a title="" data-placement="top"
                                                        data-toggle="tooltip" class="tooltips" href=""
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Dinesh.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                            <div class="___class_+?80___ pt-2">
                                                <h4>Dinesh Karthik</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Eoin.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                            <div class="___class_+?111___ pt-2">
                                                <h4>
                                                    Eoin Morgan
                                                </h4>
                                                <p class="text-muted"><span>Batsman • England</span></p>
                                            </div>
                                            <ul class="social-links list-inline">
                                                <li class="list-inline-item"><a title="" data-placement="top"
                                                        data-toggle="tooltip" class="tooltips" href=""
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Harry.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                            <div class="___class_+?141__ pt-2">
                                                <h4>Harry Gurney</h4>
                                                <p class="text-muted"><span>Bowler • England</span></p>
                                            </div>
                                            <ul class="social-links list-inline">
                                                <li class="list-inline-item"><a title="" data-placement="top"
                                                        data-toggle="tooltip" class="tooltips" href=""
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Kuldeep.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Pat.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Prasidh.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                            <div class="___class_+?232___ pt-2">
                                                <h4>Prasidh Krishna</h4>
                                                <p class="text-muted"><span>Bowler • India</span></p>
                                            </div>
                                            <ul class="social-links list-inline">
                                                <li class="list-inline-item"><a title="" data-placement="top"
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Shivam.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Shubman.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Sunil.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
                                            <div class="___class_+?322___ pt-2">
                                                <h4>Sunil Narine</h4>
                                                <p class="text-muted"><span>Bowler • West Indies</span></p>
                                            </div>
                                            <ul class="social-links list-inline">
                                                <li class="list-inline-item"><a title="" data-placement="top"
                                                        data-toggle="tooltip" class="tooltips" href=""
                                ...
                                <div class="col-lg-4">
                                    <div class="text-center card-box">
                                        <div class="member-card pt-2 pb-2">
                                            <div class="thumb-lg member-thumb mx-auto"><img
                                                    src="assets/images/teame/kkr/Tom.webp"
                                                    class="rounded-circle img-thumbnail" alt="profile-image" style="height: 90px;"></div>
