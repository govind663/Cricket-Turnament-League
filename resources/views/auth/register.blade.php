        ...
        <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <h2 class="auth-heading text-center mb-4">Sign up to Coding Thunder</h2>
                    ...
                    <div class="auth-form-container text-start mx-auto">
                        <form class="auth-form auth-signup-form" method="POST" action="{{ route('register') }}"
                            ...
                            <div class="email mb-3">
                                <label  for="signup-email">Your Name</label>
                            ...
                            <div class="email mb-3">
                                <label  for="signup-email">Your Email-id</label>

                                <input id="email" type="email"
                                    class="form-control signup-email @error('email') is-invalid @enderror" name="email"
                        ...
                        <div class="auth-option text-center pt-5">
                            Already have an account? <a class="text-link" href="/login">Log in</a>
                        </div>
                    </div>
                    <!--//auth-form-container-->
                </div>
